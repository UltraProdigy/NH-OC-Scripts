...
local redstone = component.proxy("087f2ef4-940e-4d6e-b238-397f2a65298f") -- Redstone I/O
...
local function waitForActivation()
    ...
    while true do
        if activationSignal >= 1 then
            ...
            os.sleep(260) -- Spacetime Expenditure (s)
